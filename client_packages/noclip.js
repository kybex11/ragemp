var bindASCIIKeys = {
    Q: mp.events.call('client:controls:getKey', 'q'),
    E: mp.events.call('client:controls:getKey', 'e'),
    LCtrl: mp.events.call('client:controls:getKey', 'ctrl'),
    Shift: mp.events.call('client:controls:getKey', 'shift')
};
